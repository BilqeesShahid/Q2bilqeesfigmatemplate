...
const BrowseProducts = () => {
  ...
  <div className="max-w-[350px] h-[25rem] p-2 shadow-md rounded-xl relative group">
    <div>
      <Image src="/sofa5.jpg" alt="sofa" width={400} height={400} className="w-full h-full object-cover" />
    </div>
    <h2 className="card-title text-2xl font-bold text-myblue text-center mt-2">Smart Sofa</h2>
  </div> 
  <div className="max-w-[350px] h-[25rem] p-2 shadow-md rounded-xl relative group">
    <div>
      <Image src="/table.png" alt="table" width={400} height={400} className="w-full h-full object-cover" />
    </div>
    <h2 className="card-title text-2xl font-bold text-myblue text-center mt-2">Smart Table</h2>
  </div> 
  <div className="max-w-[350px] h-[25rem] p-2 shadow-md rounded-xl relative group">
    <div>
      <Image src="/chair3.webp" alt="chair" width={400} height={400} className="w-full h-full object-cover" />
    </div>
